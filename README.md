...
Общее время выполнения работы составило 13 часов.
...
![husky](./img/husky_tests_100_coverage.png)

- **Скрипт**: `npm run prepare`
...
![appveyor](./img/appveyor_tests_100_coverage.png)
